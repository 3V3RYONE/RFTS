...
if(isset($_POST["login_btn_sender"])){  
...
if(!empty($_POST['username']) && !empty($_POST['password'])) {  
    ...
    if($user == $dbusername && $pass == $dbpassword && ($dbgroups=='Sender' || $dbgroups=='Web Admin'))  
    {  
    session_start();  
...
<body style = "background-color:#bdc3c7">
    ...
    <div class="inner_container">
	 <form action='login_sender.php' method="post">
	     ...
	     <button id="login_btn_sender" name="login_btn_sender" type="submit">LOGIN</button>
             <script>
                 var state = false;
                 function toggle(){
                     if(state){
