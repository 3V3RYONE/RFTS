...
if(isset($_POST["login_btn_receiver"])){  
...
if(!empty($_POST['username']) && !empty($_POST['password'])) {  
    ...
    if($user == $dbusername && $pass == $dbpassword && ($dbgroups=='Receiver' || $dbgroups=='Web Admin'))  
    {  
    session_start();  
...
<html>
<head>
<title>Login for Receiver</title>
    ...
    <div class="inner_container">
	 <form action='login_receiver.php' method="post">
	     ...
	     <span>
             ...
             <button id="login_btn_receiver" name="login_btn_receiver" type="submit">LOGIN</button>
	    </center>
	 </form>
     </div>
    </div>
